...
/*
use \Quill\Template\Node\BlockNode, DisplayBlockNode, BreakNode, 
...
use \Quill\Template\Expression\AndExpression,AddExpression,ArrayExpression,
...
class Parser
{
        ...
        while (!$this->stream->isEOS()) {
            ...
            case Token::BLOCK_START_TYPE:
                ...
                if (!is_null($test) && $token->test($test)) {
                    ...
                    return new ListNode($nodes, $line);
                }
    ...
    protected function parseBlock($token)
    {
        ...
        return new DisplayBlockNode($name, $token->getLine());
    }
